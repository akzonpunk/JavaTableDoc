...
<section class="content">    
    <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Formulario de Documento</h3>
            </div>
    <c:url var="urlsave" value="${pageContext.request.contextPath}/${urlAccion}" />
    <frm:form modelAttribute="modeloDocumento" method="post" action="${urlsave}" class="form-horizontal" >
  
            <div class="box-body">
                <div class="form-group">
                    <frm:hidden path="idDocumento" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <frm:input path="estado" class="form-control"  /></div>                    
                </div>
                -- /.box-body -->
              ...
              <div class="box-footer" style="margin-left: 80px">                
                  ...
                  &nbsp;&nbsp;
                  <a href="${pageContext.request.contextPath}/docMain" class="btn btn-primary">Cancelar</a> 
              </div>            
    </frm:form>
</div>
